...
-- ========================================
-- INSERT PRODUCTS (Sample products for events)
-- ========================================

-- Products for Event 1: Workshop Lập Trình Web
INSERT INTO Product (ProductName, Price, ProductImage, Description, EventId, IsActive)
VALUES (
    N'Tài liệu học tập',
    50000.00,
    '/uploads/products/workshop-material.jpg',
    N'Tài liệu chi tiết về React và Node.js',
    1,
    1
);
...
VALUES (
    N'Sticker sự kiện',
    10000.00,
    '/uploads/products/workshop-sticker.jpg',
    N'Sticker đẹp mắt của sự kiện',
    1,
    1
);

-- Products for Event 4: Concert Nhạc Acoustic
INSERT INTO Product (ProductName, Price, ProductImage, Description, EventId, IsActive)
VALUES (
    N'CD nhạc acoustic',
    150000.00,
    '/uploads/products/acoustic-cd.jpg',
    N'CD nhạc acoustic của các ca sĩ',
    4,
    1
);
...
VALUES (
    N'Áo thun sự kiện',
    200000.00,
    '/uploads/products/concert-shirt.jpg',
    N'Áo thun in hình sự kiện',
    4,
    1
);

-- Products for Event 6: Workshop Nấu Ăn Healthy
INSERT INTO Product (ProductName, Price, ProductImage, Description, EventId, IsActive)
VALUES (
    N'Công thức nấu ăn',
    80000.00,
    '/uploads/products/recipe-book.jpg',
    N'Sách công thức nấu ăn healthy',
    6,
    1
);
...
VALUES (
    N'Thực phẩm organic',
    300000.00,
    '/uploads/products/organic-food.jpg',
    N'Gói thực phẩm organic để nấu ăn',
    6,
    1
);

PRINT '6 Sample Products created for events';
