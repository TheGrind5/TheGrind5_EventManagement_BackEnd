                    ...
                    <Stack spacing={3}>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    {order.products && order.products.length > 0 && (
                                        <Grid item xs={12}>
                                            ...
                                            <Typography variant="body2" color="primary" sx={{ ml: 2, fontWeight: 'medium' }}>
                                                Tổng phụ kiện: {formatCurrency(order.productAmount || 0)}
                                            </Typography>
                                        </Grid>
                                    )}
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <Box sx={{ mb: 2 }}>
                                    <Typography variant="body2" color="text.secondary">
                                        Tổng tiền vé: {formatCurrency(order.ticketAmount || 0)}
                                    </Typography>
                                </Box>
                                
                                {/* Chi tiết phụ kiện nếu có */}
                                {order.products && order.products.length > 0 && (
                                    <Box sx={{ mb: 2 }}>
                                        <Typography variant="body2" color="text.secondary">
                                            Tổng phụ kiện: {formatCurrency(order.productAmount || 0)}
