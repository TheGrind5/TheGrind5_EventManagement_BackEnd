                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                          ...
                          <Box sx={{ textAlign: 'right' }}>
                            ...
                            <Typography variant="h6" sx={{ fontWeight: 600, color: 'primary.main', mt: 1 }}>
                              {formatPrice(ticket.totalAmount || ticket.ticketType.price)}
                            </Typography>
                          </Box>
                        </Box>
                            ...
                            <Box sx={{ mt: 2, p: 2, bgcolor: 'grey.50', borderRadius: 1 }}>
                              ...
                              {ticket.products.map((product, index) => (
                                <Box key={index} sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 0.5 }}>
                                  <Typography variant="body2">
                                    • {product.productName || `Sản phẩm ${product.productId}`} x{product.quantity}
                                  </Typography>
                              ...
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 1, pt: 1, borderTop: '1px solid', borderColor: 'grey.300' }}>
                                <Typography variant="body2" color="text.secondary">
                                  Tổng phụ kiện:
                                </Typography>
                                <Typography variant="body2" color="primary.main" sx={{ fontWeight: 'bold' }}>
                                  {formatPrice(ticket.productAmount || 0)}
                                </Typography>
                              </Box>
                            </Box>
                          )}
