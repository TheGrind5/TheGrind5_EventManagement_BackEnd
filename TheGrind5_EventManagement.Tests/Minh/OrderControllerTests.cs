...
using TheGrind5_EventManagement.Tests.Minh;
...
public class OrderControllerTests
{
    ...
    [Fact]
    public async Task UserNotExists_ReturnsUnauthorized()
    {
        // Arrange
        var request = new CreateOrderRequestDTO
        {
    ...
    [Fact]
    public async Task ConcurrentPurchase_HandlesRace()
    {
        // Arrange
        var request = new CreateOrderRequestDTO
        {
    ...
    [Fact]
    public async Task InsufficientBalance_ReturnsBadRequest()
    {
        // Arrange
        var orderId = 1;
        var request = new PaymentRequest
    ...
    [Fact]
    public async Task UnauthorizedUser_ReturnsForbid()
    {
        // Arrange
        var orderId = 1;
        var request = new PaymentRequest
    ...
    [Fact]
    public async Task OrderNotPending_ReturnsBadRequest()
    {
        // Arrange
        var orderId = 1;
        var request = new PaymentRequest
    ...
    [Fact]
    public async Task InvalidOrderId_ReturnsBadRequest()
    {
        // Arrange
    ...
    [Fact]
    public async Task UnsupportedPaymentMethod_ReturnsBadRequest()
    {
        // Arrange
        var orderId = 1;
        var request = new PaymentRequest
    ...
    [Fact]
    public async Task ProcessPayment_UpdateOrderStatusFails_ReturnsNotFound()
    {
        // Arrange
        var orderId = 1;
        var request = new PaymentRequest
    ...
    [Fact]
    public async Task ProcessPayment_ExceptionThrown_ReturnsBadRequest()
    {
        // Arrange
        var orderId = 1;
        var request = new PaymentRequest
        ...
        var response = badRequestResult.Value;
        Assert.NotNull(response);
        Assert.Contains("Có lỗi xảy ra khi xử lý thanh toán", response.ToString());
    }
