...
namespace TheGrind5.Tests.Services;
...
public class TicketServiceTests : IDisposable
{
    ...
    [Fact]
    public async Task GetTicketsByUserIdAsync_Empty_ReturnsEmptyList()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetTicketsByUserIdAsync_InvalidUser_ThrowsException()
    {
        // Arrange
        ...
        await Assert.ThrowsAsync<ArgumentException>(() => 
            _ticketService.GetTicketsByUserIdAsync(invalidUserId));
    }
    ...
    [Fact]
    public async Task CheckInTicketAsync_ValidTicket_UpdatesStatusToUsed()
    {
        // Arrange
        var ticketId = 1;
        var eventId = 1;
    ...
    [Fact]
    public async Task CheckInTicketAsync_EventEnded_ThrowsException()
    {
        // Arrange
        var ticketId = 1;
        var eventId = 1;
