...
-- Product table for event accessories
CREATE TABLE Product(
    ...
    IsActive BIT NOT NULL DEFAULT 1,
    CONSTRAINT FK_Product_Event FOREIGN KEY (EventId) REFERENCES Event(EventId) ON DELETE CASCADE
);

-- Indexes for Product table
CREATE INDEX IX_Product_EventId ON Product(EventId);
